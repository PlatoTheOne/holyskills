...
const zhCN: Dict = {
  ...
  "docs.contentProtectedHint": "可连接你的私有 API/MCP 服务返回正文内容。",
...
const zhHK: Dict = {
  ...
  "docs.contentProtectedHint": "可連接你的私有 API/MCP 服務返回正文內容。",
...
const en: Dict = {
  ...
  "docs.contentProtectedHint": "Connect your private API/MCP endpoint to fetch full content.",
